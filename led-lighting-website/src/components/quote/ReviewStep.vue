...
<template>
  <div>
    ...
    <fieldset :disabled="draft.busy || !!draft.pendingSubmission" class="q-review-layout">
      <div>
        ...
        <div class="q-review-notes">
          <QuoteField label="추가 요청사항" optional>
            <textarea
              v-model="draft.notes"
              rows="4"
              maxlength="2000"
